...
public class UserController {
    ...
    @GetMapping("/user/{type}/{value}") // 주소 파라미터
    ...
    public ResponseEntity emailAuth(@RequestBody Map<String, String> map, HttpSession session) { // JSON 단일 문자열값이 직접 String으로 매핑되지 않기 때문에 JSON과 호환되는 Map 타입으로 JSON 수신
